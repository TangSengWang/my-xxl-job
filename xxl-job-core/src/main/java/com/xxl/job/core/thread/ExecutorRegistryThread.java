                        ...
                        for (AdminBiz adminBiz: XxlJobExecutor.getAdminBizList()) {
                            try {
                                ...
                                if (registryResult!=null && ReturnT.SUCCESS_CODE == registryResult.getCode()) {
                                    ...
                                    System.out.println(">>>>>>>>>>> xxl-job registry success, registryParam:{}, registryResult:{}"+ registryParam+registryResult);
                                    break;
                                } else {
                                    logger.info(">>>>>>>>>>> xxl-job registry fail, registryParam:{}, registryResult:{}", new Object[]{registryParam, registryResult});
                                    System.out.println(">>>>>>>>>>> xxl-job registry fail, registryParam:{}, registryResult:{}"+ new Object[]{registryParam, registryResult});
                                }
                            } catch (Exception e) {
                                logger.info(">>>>>>>>>>> xxl-job registry error, registryParam:{}", registryParam, e);
                                System.out.println(">>>>>>>>>>> xxl-job registry error, registryParam:{}, registryResult:{}"+ registryParam+e);
                            }
